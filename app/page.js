  ...
  return (
    <main>
      <header className="site-header">
        <a href="#top" className="brand" aria-label="Studio B. home">
      ...
      <section className="intro-strip">
        <p>
          A collection of quiet rooms, distant skies, small wishes and places that feel a little like memory.
        </p>
      </section>
      ...
      <section className="feature-quote" aria-label="Artist note">
        <span className="quote-small">A note on the work</span>
        <p>“I like the moment when an ordinary place begins to feel like its own little universe.”</p>
        <span className="quote-note">Placeholder artist statement — replace with her own words.</span>
      </section>
      ...
      <section className="about-section" id="about">
        ...
        <div className="about-copy">
          <h2>Made with attention to the small things.</h2>
          <p>
            Add her short bio here: where she is based, the materials she returns to, what she notices, and what she hopes people feel when they spend time with her work.
          </p>
          <p className="about-subtle">This section is intentionally personal and concise. Her own voice will make it much stronger.</p>
        </div>
