  ...
  return (
    <main>
      <header className="site-header">
        <a href="#top" className="brand" aria-label="Artist portfolio home">
      ...
      <section className="about-section" id="about">
        ...
        <div className="about-copy">
          ...
          <p className="about-subtle">This section will be completed once her preferred bio and artist statement are ready.</p>
        </div>
